                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold text-gray-900">
                                <?php echo e($grupo_id ? 'Editar Grupo' : 'Novo Grupo'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="overflow-x-auto rounded-xl border border-gray-200 shadow-sm">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $grupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-3">
                                            <button wire:click="edit(<?php echo e($grupo->id); ?>)"
                                                    type="button"
                                            ...
                                            <button wire:click="delete(<?php echo e($grupo->id); ?>)"
                                                    type="button"
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md transition duration-200">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-900"><?php echo e($grupo->nome); ?></h3>
                                    <p class="text-sm text-gray-500">ID: #<?php echo e($grupo->id); ?></p>
                                </div>
                            </div>
                        </div>
            ...
            <!-- Paginação -->
            <!--[if BLOCK]><![endif]--><?php if($grupos->hasPages()): ?>
...
<?php /**PATH /home/igor/gestao-grupos/resources/views/livewire/grupos.blade.php ENDPATH**/ ?>