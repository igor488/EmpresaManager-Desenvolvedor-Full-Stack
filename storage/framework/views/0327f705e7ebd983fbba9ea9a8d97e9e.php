        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl shadow-lg text-white p-4 md:p-6 mb-6 md:mb-8">
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 md:gap-4">
                    <div class="flex-1">
                        <h1 class="text-xl md:text-2xl lg:text-3xl font-bold mb-2">Bem-vindo, <?php echo e(auth()->user()->name); ?>! 👋</h1>
                    ...
                    <div class="text-left md:text-right mt-2 md:mt-0">
                        <p class="text-blue-100 text-xs md:text-sm lg:text-base"><?php echo e(now()->format('d/m/Y - H:i')); ?></p>
                ...
                <div class="bg-white rounded-xl shadow-sm p-3 md:p-4 lg:p-6 border-l-4 border-blue-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg md:text-xl lg:text-2xl font-bold text-gray-900"><?php echo e($totalGrupos); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-3 md:p-4 lg:p-6 border-l-4 border-green-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg md:text-xl lg:text-2xl font-bold text-gray-900"><?php echo e($totalBandeiras); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-3 md:p-4 lg:p-6 border-l-4 border-yellow-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg md:text-xl lg:text-2xl font-bold text-gray-900"><?php echo e($totalUnidades); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-3 md:p-4 lg:p-6 border-l-4 border-red-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg md:text-xl lg:text-2xl font-bold text-gray-900"><?php echo e($totalColaboradores); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
                ...
                <div class="bg-white rounded-xl shadow-sm p-4 md:p-6">
                        ...
                        <div class="flex items-start space-x-2 md:space-x-3">
                            <div class="flex-shrink-0">
                                <div class="w-6 h-6 md:w-7 md:h-7 rounded-full flex items-center justify-center text-xs
                                    <?php if($atividade->acao == 'criado'): ?> bg-green-100 text-green-600
                                    <?php elseif($atividade->acao == 'atualizado'): ?> bg-yellow-100 text-yellow-600
                                    <?php else: ?> bg-red-100 text-red-600 <?php endif; ?>">
                                    <i class="fas
                                        <?php if($atividade->acao == 'criado'): ?> fa-plus
                                        <?php elseif($atividade->acao == 'atualizado'): ?> fa-edit
                                        <?php else: ?> fa-trash <?php endif; ?> text-xs">
                                    </i>
                                </div>
                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-medium text-gray-900 truncate">
                                    <?php echo e($atividade->entidade); ?> <?php echo e($atividade->acao); ?>

                                </p>
                                <p class="text-xs text-gray-500 truncate">
                                    Por: <?php echo e($atividade->user->name ?? 'Sistema'); ?> •
                                    <?php echo e($atividade->created_at->diffForHumans()); ?>
                    ...
                    <?php if($atividadesRecentes->count() > 0): ?>
                    <a href="<?php echo e(route('auditorias')); ?>"
...
<?php endif; ?>
<?php /**PATH /home/igor/gestao-grupos/resources/views/dashboard.blade.php ENDPATH**/ ?>