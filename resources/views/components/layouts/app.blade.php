        ...
        <div id="sidebar"
            ...
            <nav class="p-3 md:p-4 space-y-1 mt-2 md:mt-4">
                <a href="{{ route('dashboard') }}"
                   ...
                   class="nav-item flex items-center px-3 md:px-4 py-2 md:py-3 text-blue-100 {{ Route::currentRouteName() == 'dashboard' ? 'active' : '' }}">
                ...
                <a href="{{ route('livewire.grupos') }}"
                   onclick="closeSidebarMobile()"
                   class="nav-item flex items-center px-3 md:px-4 py-2 md:py-3 text-blue-100 {{ Route::currentRouteName() == 'livewire.grupos' ? 'active' : '' }}">
                ...
                <a href="{{ route('livewire.bandeiras') }}"
                   onclick="closeSidebarMobile()"
                   class="nav-item flex items-center px-3 md:px-4 py-2 md:py-3 text-blue-100 {{ Route::currentRouteName() == 'livewire.bandeiras' ? 'active' : '' }}">
                ...
                <a href="{{ route('livewire.unidades') }}"
                   onclick="closeSidebarMobile()"
                   class="nav-item flex items-center px-3 md:px-4 py-2 md:py-3 text-blue-100 {{ Route::currentRouteName() == 'livewire.unidades' ? 'active' : '' }}">
                ...
                <a href="{{ route('livewire.colaboradores') }}"
                   onclick="closeSidebarMobile()"
                   class="nav-item flex items-center px-3 md:px-4 py-2 md:py-3 text-blue-100 {{ Route::currentRouteName() == 'livewire.colaboradores' ? 'active' : '' }}">
                ...
                <a href="{{ route('relatorio.colaboradores') }}"
                   onclick="closeSidebarMobile()"
                   class="nav-item flex items-center px-3 md:px-4 py-2 md:py-3 text-blue-100 {{ Route::currentRouteName() == 'relatorio.colaboradores' ? 'active' : '' }}">
                ...
                <a href="{{ route('auditorias') }}"
                   onclick="closeSidebarMobile()"
                   class="nav-item flex items-center px-3 md:px-4 py-2 md:py-3 text-blue-100 {{ Route::currentRouteName() == 'auditorias' ? 'active' : '' }}">
                ...
                <div class="flex items-center justify-between px-4 md:px-6 lg:px-8 py-3 md:py-4">
                    ...
                    <div class="flex items-center space-x-2 md:space-x-4">
                        ...
                        <div class="flex items-center space-x-1 md:space-x-2 text-xs md:text-sm text-gray-600">
                            ...
                            <span class="text-gray-900 font-medium truncate max-w-[120px] sm:max-w-none">{{ $title ?? 'Página Inicial' }}</span>
                        </div>
                    </div>
            ...
            <main class="p-4 md:p-6 lg:p-8">
                ...
                @if (session('message'))
                    <div class="mb-4 md:mb-6 bg-blue-50 border border-blue-200 rounded-xl p-3 md:p-4 flex items-center">
                        ...
                        <span class="text-blue-700 text-sm md:text-base">{{ session('message') }}</span>
                    </div>
                @endif
