                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-gray-900">
                                    {{ $colaborador_id ? 'Editar Colaborador' : 'Novo Colaborador' }}
                                </h3>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($colaboradores as $colaborador)
                                <tr class="hover:bg-gray-50 transition duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        {{ $this->formatarCpf($colaborador->cpf) }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md transition duration-200">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-900">{{ $colaborador->nome }}</h3>
                                    <p class="text-sm text-gray-500">ID: #{{ $colaborador->id }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2 mb-4">
                            <div class="flex justify-between items-center py-1 border-b border-gray-100">
                                ...
                                <span class="text-sm text-gray-900 truncate max-w-[150px]">{{ $colaborador->email }}</span>
                            </div>
                            <div class="flex justify-between items-center py-1 border-b border-gray-100">
                                <span class="text-sm font-medium text-gray-600">CPF:</span>
                                <span class="text-sm text-gray-900">{{ $this->formatarCpf($colaborador->cpf) }}</span>
                            </div>
                            <div class="flex justify-between items-center py-1 border-b border-gray-100">
                                <span class="text-sm font-medium text-gray-600">Unidade:</span>
                                <span class="text-sm text-gray-900">{{ $colaborador->unidade->nome_fantasia ?? '-' }}</span>
                            </div>
                        </div>
